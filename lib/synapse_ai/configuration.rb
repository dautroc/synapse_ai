...
module SynapseAi
  class Configuration
    attr_accessor :provider, :openai_api_key, :google_api_key, :log_level, :default_timeout
    ...
    # @param google_api_key [String] The API key for the Google provider.
    # @param log_level [Symbol] The log level to use for logging.
    def initialize
      @provider = :openai # Default provider
      @openai_api_key = ENV["OPENAI_API_KEY"]
      @google_api_key = ENV["GOOGLE_API_KEY"] # Future
      @log_level = :info
